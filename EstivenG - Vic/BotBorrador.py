...
# ============================== GUARDAR RESULTADO ==============================
df_consolidado.to_excel("C:\\Users\\ADSO\\Documents\\EstivenG-Vixtor\\EstivenG - Vic\\consolidado_limpio.xlsx", index=False)
...
plt.tight_layout()
plt.savefig("C:\\Users\\ADSO\\Documents\\EstivenG-Vixtor\\EstivenG - Vic\\grafico_categoria.png", dpi=150)
plt.show()
...
plt.ylabel("")
plt.tight_layout()
plt.savefig("C:\\Users\\ADSO\\Documents\\EstivenG-Vixtor\\EstivenG - Vic\\grafico_vendedor.png", dpi=150)
plt.show()
...
plt.xticks(rotation=0)
plt.tight_layout()
plt.savefig("C:\\Users\\ADSO\\Documents\\EstivenG-Vixtor\\EstivenG - Vic\\grafico_metodo_pago.png", dpi=150)
plt.show()
...
plt.tight_layout()
plt.savefig("C:\\Users\\ADSO\\Documents\\EstivenG-Vixtor\\EstivenG - Vic\\grafico_dia_semana.png", dpi=150)
plt.show()
